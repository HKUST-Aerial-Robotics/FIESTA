...
public:
    ...
    void setParameter(double pHit, double pMiss, double pMin, double pMax, double pOcc) {
        prob_hit_log_ = logit(pHit);
        prob_miss_log_ = logit(pMiss);
        clamp_min_log_ = logit(pMin);
        clamp_max_log_ = logit(pMax);
        min_occupancy_log_ = logit(pOcc);
    }
