...
ros::Publisher occ_pointcloud_pub;
...
//    occ_pub.publish(occ_marker);
    ...
    esdf_map->getSliceMarker(slice_marker, 10, 3, Eigen::Vector4d(0, 1.0, 0, 1));
...
//    cout << std::thread::hardware_concurrency() << endl;
    ...
    float update_mesh_every_n_sec = 0.1f;
